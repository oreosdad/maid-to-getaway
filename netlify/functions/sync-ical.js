    ...
    for (const evt of validEvents) {
      ...
      if (groupMap[prop.id]) {
        ...
        for (const sibJob of allSibJobs) {
          // Use guest_arrival = when NEW guests arrive for this sibling job
          // Fall back to scheduled_date + sibling prop checkin time
